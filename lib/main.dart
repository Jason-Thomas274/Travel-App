...
class MyHomePage extends StatelessWidget {
  final List<Destination> popularDestinations = [
    ...
    Destination(name: 'Korea', imageUrl: 'https://images.pexels.com/photos/2122406/pexels-photo-2122406.jpeg')
  ];
...
class DestinationFlipCard extends StatefulWidget {
  final Destination destination;
  final VoidCallback? onTap;

  const DestinationFlipCard({
    required this.destination,
    this.onTap,
  });

  @override
  _DestinationFlipCardState createState() => _DestinationFlipCardState();
}

class _DestinationFlipCardState extends State<DestinationFlipCard> {
